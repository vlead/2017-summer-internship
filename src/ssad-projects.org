...
* Name of the Company :: Virtual Labs Engineering, Architecture and Design

* Mentor Names : VLEAD

* Mentor's Email ID: engg@vlabs.ac.in

* Primary Work Location:  B-204 Vindhya C6
...
* Technology :: Python, Flask Microframeowrk, Javascript, Ansible


* Mentor Mapping
|------+-----------------------------------+---------------------+---------------------|
| S.no | Project Name                      | Mentor Name         | email id            |
|------+-----------------------------------+---------------------+---------------------|
|   1. | Experiment as a service           | Thirumal Ravula     | travula@vlabs.ac.in |
|------+-----------------------------------+---------------------+---------------------|
|   2. | Conversion of Virtual experiments | Lalit               |                     |
|------+-----------------------------------+---------------------+---------------------|
|   3. | Systems Dashboard                 | Thirumal Ravula     |                     |
|------+-----------------------------------+---------------------+---------------------|
|   4. | Linux Lab                         | Venkatesh Choppella |                     |
|------+-----------------------------------+---------------------+---------------------|
|   5. | Data structures lab               | Venkatesh Choppella |                     |
|------+-----------------------------------+---------------------+---------------------|
|   6. | Data Visualization                | Devi Prasad         |                     |
|------+-----------------------------------+---------------------+---------------------|
|   7. | Virtual Labs Portal               | Devi Prasad         |                     |
|------+-----------------------------------+---------------------+---------------------|
|   8. | Lab Authoring Platform            | Lalit               |                     |
|------+-----------------------------------+---------------------+---------------------|
|   9. | Oauth for VLEAD services          | Thirumal Ravula     |                     |
|------+-----------------------------------+---------------------+---------------------|
|  10. | User Directory                    | Venkatesh Choppella |                     |
|------+-----------------------------------+---------------------+---------------------|
|  11. | Re-Narration                      | Sai Gollapudi       |                     |
|------+-----------------------------------+---------------------+---------------------|
|  12. | Lab Data Service Dashboard        | Thirumal Ravula     |                     |
|------+-----------------------------------+---------------------+---------------------|
|  13. | Automate Cluster creation         | Siva Sankar         |                     |
