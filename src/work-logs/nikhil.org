...
** Week 2 [2017-07-10 Mon] till [2017-07-16 Sun]
   ...
   + [2017-07-14 Fri]
      ...
      - Gathered resources to improvise the experiments of linux-lab
      - These are some of the links I used for studying python :-
                                                           - [[https://developers.google.com/edu/python/]] : For beginners
** Week 3 [2017-07-17 Mon] till [2017-07-20 Thr]
   ...
   + [2017-07-19 Wed] : Finalized the posters for the presentation. Also condensed the paper further. Edited the background and modeling sections of the paper. In addition, started work on final report of the internship.
   + [2017-07-20 Thr] :  Worked on creating the handouts for the internship presentation. Also finished up the final report for the different projects that I have worked on. Presented the posters to all those who came. Rest of the day was spent on working on reductions in the web-security paper.
