...
** Week 3 [2017-07-17 Mon] till [2017-07-20 Thr]
   ...
   + [2017-07-19 Wed] : Finalized the posters for the presentation. In addition, started work on final report of the internship.
   + [2017-07-20 Thr] :  Worked on creating the handouts for the internship presentation. Also finished up the final report for the different projects that I have worked on. Presented the posters to all those who came.
