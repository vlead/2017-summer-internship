...
** Week 2 [2017-06-05 Mon] till [2017-06-11 Sun]
   ...
   + [2017-06-12 Mon]- Design part was done and coding also complete of merge sort. Faced some difficulties in placing html elements in form of a binary tree. Tried a few techniques but was not able to find a concrete solution. Will be able to complete it by today night. 
