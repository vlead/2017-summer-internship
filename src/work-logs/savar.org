...
[2017-06-21 Thu]:I added the issue raising feature to our CI app.It is able to raise an issue whenever a build is unsuccessful and attach the respective label to it.Also I am working on making the code written so far more object oriented.
* Month of July
