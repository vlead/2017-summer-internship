...
** Week 7 [2017-06-19 Mon] till [2017-06-25 Sun]
   + [2017-06-19 Mon]- Created org files for all the containers and updated them with all code that has been written.Modified all the playbooks with some variable changes,Some renames etc.Org files working fine .Tangling is fine.Working good.Need to test on other host machine tomorrow
* Repository link
