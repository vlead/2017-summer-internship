...
** Week 5 [2017-06-05] till [2017-06-11 sun]
  + [2017-06-05 Mon]-Automated ossec-server,rsyslog-server.Stuck on config-server while creating user in remote user.
  + [2017-06-06 Tues]-Fixed user problem.Automated copying ssh keys of localhost to config server.Copying config-server keys to localmachine and to router.
* Repository link
