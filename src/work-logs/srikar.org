...
[2018-07-05] Due to a sudden difficulty with websockets, I shifted my focus onto getting it to work on CentOS for a day. I tried getting different flask apps using websockets to work on the CentOS container.
