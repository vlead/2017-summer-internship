...
+ [2017-06-12 Mon] - Installed elk stack in a container.Started working on coverting text files to json files using logstash plugins. visualized graphs for some logs using kibana dashboard.
