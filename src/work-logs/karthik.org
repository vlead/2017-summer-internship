...
+ [2017-07-03 Mon] - Worked on automation of copying of files from host machine to a base4 container.Remotely copied files over ssh without using password by generating ssh keys.Read the documentaion of automation of cluster.
