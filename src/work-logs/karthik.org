...
+ [2017-06-14 Wed] - Working on logstashplugins which utomatically takes logs from syslogs and convert them into json format and export to elasticsearch  which is connected kibana.
