...
+ [2017-07-04 Tue] - Worked on automation of conversion of nmon files generated
  into .html format by using shell script.Successfully completed the above
...
+ [2017-07-05 Wed] - Worked on making some changes in the html files before
  ...
  task.Also worked on automation of links of output files while visualizing the output.
* Repository link
